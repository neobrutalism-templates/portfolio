...
export default function Nav() {
  ...
  return (
    <div className="fixed top-5 left-0 z-50 w-full">
      <nav className="text-main-foreground border-border shadow-shadow rounded-base bg-main dark:bg-[#1c0252] font-base mx-auto flex w-[750px] max-w-full items-center border-2 p-2.5 px-5 text-sm sm:text-base">
